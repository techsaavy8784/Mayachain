...
class TestAsset(unittest.TestCase):
    def test_constructor(self):
        ...
        asset = Asset("BNB")
        self.assertEqual(asset, "MAYA.BNB")
        asset = Asset(CACAO)
        self.assertEqual(asset, CACAO)
        asset = Asset(CACAO)
        self.assertEqual(asset, CACAO)
    ...
    def test_get_symbol(self):
        ...
        asset = Asset(CACAO)
        self.assertEqual(asset.get_symbol(), CACAO.get_symbol())
        asset = Asset("LOK-3C0")
    ...
    def test_get_ticker(self):
        ...
        asset = Asset(CACAO)
        self.assertEqual(asset.get_ticker(), "CACAO")
        asset = Asset("LOK-3C0")
    ...
    def test_get_chain(self):
        ...
        asset = Asset(CACAO)
        self.assertEqual(asset.get_chain(), CACAO.get_chain())
        asset = Asset("LOK-3C0")
        self.assertEqual(asset.get_chain(), "MAYA")

    def test_is_cacao(self):
        asset = Asset("BNB.BNB")
        self.assertEqual(asset.is_cacao(), False)
        asset = Asset(CACAO)
        self.assertEqual(asset.is_cacao(), True)
        asset = Asset("LOK-3C0")
        self.assertEqual(asset.is_cacao(), False)
        asset = Asset("CACAO")
        self.assertEqual(asset.is_cacao(), True)
    ...
    def test_to_json(self):
        ...
        asset = Asset(CACAO)
        self.assertEqual(asset.to_json(), json.dumps(CACAO))
...
class TestCoin(unittest.TestCase):
    def test_constructor(self):
        ...
        coin = Coin(CACAO, 1000000)
        self.assertEqual(coin.amount, 1000000)
        self.assertEqual(coin.asset, CACAO)

        coin = Coin(CACAO, 400_000 * 100000000)
        c = coin.__dict__
        self.assertEqual(c["amount"], 400_000 * 100000000)
        self.assertEqual(c["asset"], CACAO)
    ...
    def test_eq(self):
        ...
        self.assertEqual(coin1, coin2)
        # check list equality
        list1 = [Coin("CACAO", 100), Coin("CACAO", 100)]
        list2 = [Coin("CACAO", 100), Coin("CACAO", 100)]
        self.assertEqual(list1, list2)
        list1 = [Coin("CACAO", 100), Coin("CACAO", 100)]
        list2 = [Coin("CACAO", 10), Coin("CACAO", 100)]
        self.assertNotEqual(list1, list2)
        # list not sorted are NOT equal
        list1 = [Coin("CACAO", 100), Coin("BNB.BNB", 200)]
        list2 = [Coin("BNB.BNB", 200), Coin("CACAO", 100)]
        self.assertNotEqual(list1, list2)
        self.assertEqual(sorted(list1), sorted(list2))
        # check sets
        list1 = [Coin("CACAO", 100), Coin("CACAO", 100)]
        self.assertEqual(len(set(list1)), 1)
        list1 = [Coin("CACAO", 100), Coin("CACAO", 10)]
        self.assertEqual(len(set(list1)), 2)

    def test_is_cacao(self):
        coin = Coin("BNB.BNB")
        self.assertEqual(coin.is_cacao(), False)
        coin = Coin(CACAO)
        self.assertEqual(coin.is_cacao(), True)
        coin = Coin("LOK-3C0")
        self.assertEqual(coin.is_cacao(), False)
        coin = Coin("CACAO")
        self.assertEqual(coin.is_cacao(), True)
    ...
    def test_to_binance_fmt(self):
        ...
        coin = Coin("CACAO", 1000000)
        self.assertEqual(coin.to_binance_fmt(), {"denom": "CACAO", "amount": 1000000})
    ...
    def test_str(self):
        ...
        coin = Coin(CACAO, 1000000)
        self.assertEqual(str(coin), "0.01000000 " + CACAO)
    ...
    def test_repr(self):
        ...
        coin = Coin(CACAO, 1000000)
        self.assertEqual(repr(coin), f"<Coin 0.01000000 {CACAO}>")
        coin = Coin("BNB.LOK-3C0", 1000000)
    ...
    def test_to_json(self):
        ...
        coin = Coin(CACAO, 1000000)
        self.assertEqual(coin.to_json(), '{"asset": "' + CACAO + '", "amount": 1000000}')
        coin = Coin("BNB.LOK-3C0", 1000000)
...
class TestTransaction(unittest.TestCase):
    def test_constructor(self):
        ...
        txn.coins = [Coin("BNB.BNB", 1000000000), Coin(CACAO, 1000000000)]
        self.assertEqual(txn.coins[0].asset, "BNB.BNB")
        self.assertEqual(txn.coins[0].amount, 1000000000)
        self.assertEqual(txn.coins[1].asset, CACAO)
    ...
    def test_eq(self):
        ...
        self.assertEqual(tx1, tx2)
        tx2.coins = [Coin("BNB.BNB", 100), Coin("CACAO", 100)]
        self.assertNotEqual(tx1, tx2)
        # different list of coins not equal
        tx1.coins = [Coin("CACAO", 200), Coin("CACAO", 100)]
        tx2.coins = [Coin("BNB.BNB", 100), Coin("CACAO", 200)]
        self.assertNotEqual(tx1, tx2)
        # coins different order tx are still equal
        tx1.coins = [Coin("CACAO", 200), Coin("BNB.BNB", 100)]
        tx2.coins = [Coin("BNB.BNB", 100), Coin("CACAO", 200)]
        self.assertEqual(tx1, tx2)
