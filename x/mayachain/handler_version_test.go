...
func (k *TestVersionlKeeper) HasCoins(ctx cosmos.Context, addr cosmos.AccAddress, coins cosmos.Coins) bool {
	return !k.failHasCoins
}
...
func (s *HandlerVersionSuite) TestValidate(c *C) {
	...
	keeper.failHasCoins = true
	msg4 := NewMsgSetVersion(ver.String(), keeper.na.NodeAddress)
