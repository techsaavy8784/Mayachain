...
func newSwapperV109() *SwapperV109 {
	return &SwapperV109{}
}

// validateMessage is trying to validate the legitimacy of the incoming message and decide whether THORNode can handle it
func (s *SwapperV109) validateMessage(tx common.Tx, target common.Asset, destination common.Address) error {
...
func (s *SwapperV109) burnCoins(ctx cosmos.Context, keeper keeper.Keeper, coins common.Coins) error {
...
func (s *SwapperV109) swapOne(ctx cosmos.Context,
