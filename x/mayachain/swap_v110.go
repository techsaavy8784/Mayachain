...
func (s *SwapperV110) burnCoins(ctx cosmos.Context, keeper keeper.Keeper, coins common.Coins) error {
...
func (s *SwapperV110) swapOne(ctx cosmos.Context,
	...
	// Set asset to our non-cacao asset
	asset := source
	if source.IsBase() {
		asset = target
	}
...
// nolint
func (s *SwapperV110) CalcSwapSlip(Xi, xi cosmos.Uint, slipFeeAddedBasisPoints cosmos.Uint) cosmos.Uint {
	// Cast to DECs
