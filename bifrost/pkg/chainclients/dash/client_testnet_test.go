...
func (s *DashSuite) TestGetAddressesFromScriptPubKeyResult(c *C) {
...
func (s *DashSuite) TestGetAccount(c *C) {
	acct, err := s.client.GetAccount("tmayapub1addwnpepqt7qug8vk9r3saw8n4r803ydj2g3dqwx0mvq5akhnze86fc536xcycgtrnv", nil)
	c.Assert(err, IsNil)
