...
func (r ApiBucketRequest) Execute() (*Bucket, *http.Response, error) {
	return r.ApiService.BucketExecute(r)
}
...
*/
func (a *BucketsApiService) Bucket(ctx context.Context, asset string) ApiBucketRequest {
	return ApiBucketRequest{
		ApiService: a,
		ctx: ctx,
		asset: asset,
...
func (a *BucketsApiService) BucketExecute(r ApiBucketRequest) (*Bucket, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BucketsApiService.Bucket")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/mayachain/bucket/{asset}"
...
*/
func (a *BucketsApiService) Buckets(ctx context.Context) ApiBucketsRequest {
	return ApiBucketsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *BucketsApiService) BucketsExecute(r ApiBucketsRequest) ([]Bucket, *http.Response, error) {
	...
	localVarPath := localBasePath + "/mayachain/buckets"
