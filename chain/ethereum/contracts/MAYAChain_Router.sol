...
contract MAYAChain_Router {
     ...
     * @param asset address - ARC20 asset or zero address for ARB
     ...
     * @dev Example Memo: "~1b3:ETH.0xFinalToken:0xTo:
     ...
     * @param finalToken address - ARC20 asset or zero address for ARB
     ...
     * @param _asset address - ARC20 asset or zero address for ARB
     * @param _amount uint - amount to transfer
     */
